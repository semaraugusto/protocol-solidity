...
library VAnchorEncodeInputs {
  ...
  function _encodeInputs2(
    ...
    if (maxEdges == 1) {
      ...
      result[1] = roots[1];
      // assign input
      uint256 i0 = uint256(_args.publicAmount);
      uint256 i1 = uint256(_args.extDataHash);
      uint256 i2 = uint256(_args.inputNullifiers[0]);
      uint256 i3 = uint256(_args.inputNullifiers[1]);
      uint256 i4 = uint256(_args.outputCommitments[0]);
      uint256 i5 = uint256(_args.outputCommitments[1]);
      uint256 i6 = uint256(_chainId);
      uint256 i7 = uint256(roots[0]);
      uint256 i8 = uint256(roots[1]);
      assembly {
  ...
  function _encodeInputs16(
    ...
    if (maxEdges == 1) {
      ...
      //encodedInput = abi.encodePacked(inputs);
      {
          ...
          uint256 i2 = uint256(_args.inputNullifiers[0]);
          uint256 i3 = uint256(_args.inputNullifiers[1]);
          uint256 i4 = uint256(_args.inputNullifiers[2]);
          assembly {
              mstore(add(data, 0xa0), i4)
              mstore(add(data, 0x80), i3)
              mstore(add(data, 0x60), i2)
      ...
      {
          uint256 i5 = uint256(_args.inputNullifiers[3]);
          uint256 i6 = uint256(_args.inputNullifiers[4]);
          uint256 i7 = uint256(_args.inputNullifiers[5]);
          uint256 i8 = uint256(_args.inputNullifiers[6]);
          uint256 i9 = uint256(_args.inputNullifiers[7]);
          assembly {
      ...
      {
          uint256 i10 = uint256(_args.inputNullifiers[8]);
          uint256 i11 = uint256(_args.inputNullifiers[9]);
          uint256 i12 = uint256(_args.inputNullifiers[10]);
          uint256 i13 = uint256(_args.inputNullifiers[11]);
          uint256 i14 = uint256(_args.inputNullifiers[12]);
          assembly {
      ...
      {
          uint256 i15 = uint256(_args.inputNullifiers[13]);
          uint256 i16 = uint256(_args.inputNullifiers[14]);
          uint256 i17 = uint256(_args.inputNullifiers[15]);
          uint256 i18 = uint256(_args.outputCommitments[0]);
          uint256 i19 = uint256(_args.outputCommitments[1]);
          assembly {
      ...
      {
          uint256 i20 = uint256(_chainId);
          uint256 i21 = uint256(roots[0]);
          uint256 i22 = uint256(roots[1]);
          assembly {
