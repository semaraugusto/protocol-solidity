...
async function run() {
  const tokenTx = await mintCompTokens('0x7Cec2Bf7D9c4C3C96Da8a0BfeBAB1E84b8212394', "0xc2eb6995266649D2C8bbD228fc41e232C8BEca3C", '1000000000000000000000', wallet);
